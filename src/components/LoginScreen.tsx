...
const LoginScreen: React.FC<LoginScreenProps> = ({ error }) => {
  return (
              ...
              <div>
                ...
                {error.includes('Client ID') && (
                  <p className="mt-2 text-xs text-red-700">
                    Please create a <code>.env</code> file in the project root and add your Meetup Client ID:
                    <br />
                    <code className="block mt-1 p-2 bg-red-100 rounded">VITE_MEETUP_CLIENT_ID=your_client_id_here</code>
                  </p>
                )}
              </div>
            </div>
